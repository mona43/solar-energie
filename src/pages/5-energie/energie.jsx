    ...
    <div>
        <div className='energie-container'>
            <div className="title-energie">
                <h1>Energie</h1>
                <p>
                Bei MFM ELEKTRO sind wir auf die Reparatur und Installation elektrischer Anlagen im Innen- und Außenbereich spezialisiert und bieten erstklassige Reparatur.
                </p>
            </div>
            <div>
                <svg
        ...
        >
          ...
          <g className="parallax">
            <use xlinkHref="#gentle-wave" x="48" y="0" fill="rgba(134, 179, 124, 0.65)" />
            <use xlinkHref="#gentle-wave" x="48" y="3" fill="rgba(67, 197, 41, 0.65)" />
            <use xlinkHref="#gentle-wave" x="48" y="5" fill="rgba(169, 208, 161, 0.65)" />
            <use xlinkHref="#gentle-wave" x="48" y="7" fill="rgba(75, 211, 48, 0.5)" />
          </g>
                </svg>
            </div>
        </div>
